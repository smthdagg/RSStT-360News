...
`https://smthdagg.github.io/Smthdagg-Repo-feeds/RSSTT-360News/`
...
echo "src/gz RSSTT-360News https://smthdagg.github.io/Smthdagg-Repo-feeds/RSSTT-360News" \
  >> /etc/opkg/customfeeds.conf
# 3) 安装 / install
opkg update && opkg install RSSTT-360News
```
