...
# ZCode: 压制 Telethon 连接断开的吵闹日志（"Server closed the connection" 等无害警告）
import logging as _logging
_logging.getLogger('telethon.network.connection.connection').setLevel(_logging.ERROR)
_logging.getLogger('telethon.network.connection').setLevel(_logging.ERROR)
